...
# -> columns의 index중 변경을 원하는 하나만 설정 가능
# -> 원본은 변화없음. 결과가 적용된 복사본이 생성
df3 = df.rename( columns={"국어" : "kor",  "수학" : "mat", "과학" : "sinc", "영어" : "eng"}, index ={ "철수" : "cs", "민철" : "mc", "호영" : "hy", "영희" : "yh", "수현" : "sh"} )
print_df(df3)

# 원본을 수정하고자 하는 경우 inplace 파마리터에 True를 지정한다.
